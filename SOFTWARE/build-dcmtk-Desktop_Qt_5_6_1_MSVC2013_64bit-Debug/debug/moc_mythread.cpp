...
QT_MOC_LITERAL(3, 19, 13) // "make_progress"

    },
    "Mythread\0progress\0\0make_progress"
};
...
void Mythread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->make_progress((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Mythread::progress)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Mythread::progress(int _t1)
{
